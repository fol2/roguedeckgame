...
export const combatPlaybackPolicies = {
  ...
  EnemyCardMoved: { policy: "animated", visualRoute: "fx" },
  EnemyCardResolved: { policy: "animated", visualRoute: "fx" },
  EnemyDeckShuffled: { policy: "animated", visualRoute: "fx" },
  EnemyIntentVisibilityChanged: { policy: "animated", visualRoute: "fx" },
  EnemyPlanChanged: { policy: "animated", visualRoute: "fx" },
  EnemyPlanCreated: { policy: "animated", visualRoute: "fx" },
  EnemyPlanFinalized: { policy: "animated", visualRoute: "fx" },
  EnemyTeamPlanCreated: { policy: "animated", visualRoute: "fx" },
