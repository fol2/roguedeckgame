...
export type EnemyCardInstanceId = Brand<string, "EnemyCardInstanceId">;
...
export type RewardPoolId = Brand<string, "RewardPoolId">;
...
export type PlayerClassModifierId = Brand<string, "PlayerClassModifierId">;
...
export type MonsterGroupId = Brand<string, "MonsterGroupId">;
...
export const enemyCardInstanceId = (value: string): EnemyCardInstanceId => value as EnemyCardInstanceId;
...
export const rewardPoolId = (value: string): RewardPoolId => value as RewardPoolId;
...
export const playerClassModifierId = (value: string): PlayerClassModifierId => value as PlayerClassModifierId;
...
export const monsterGroupId = (value: string): MonsterGroupId => value as MonsterGroupId;
