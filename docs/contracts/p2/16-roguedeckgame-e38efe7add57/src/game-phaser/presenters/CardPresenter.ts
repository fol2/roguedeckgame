  ...
  public render(cards: readonly CombatCardViewModel[], locked: boolean, options: CardRenderOptions = {}): void {
    ...
    cards.forEach((card, index) => {
      ...
      if (!locked) {
        ...
        group.on("pointerover", () => this.onHoverChanged(card.cardInstanceId));
      ...
      group.add(this.scene.add.text(-CARD_SIZE.width / 2 + CARD_TEXT.leftPadding, CARD_SIZE.height / 2 - CARD_TEXT.tagBottomInset, tagText, {
