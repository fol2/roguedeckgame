...
```txt
combat.vfx.petCommand.thread
combat.vfx.petCommand.marker
combat.vfx.petCommand.endpointRuneFlash
...
| --- | --- | --- | --- | --- |
| Command thread | `combat.vfx.petCommand.thread` | `combat_vfx_pet_command_thread.png` | code curve | card -> Ember Fox command relationship |
| Command marker | `combat.vfx.petCommand.marker` | `combat_vfx_pet_command_marker.png` | code marker | moving ember dot/marker along command line |
| Endpoint rune flash | `combat.vfx.petCommand.endpointRuneFlash` | `combat_vfx_pet_command_endpoint_rune_flash.png` | code pulse | flash at Ember Fox ring/rune |
